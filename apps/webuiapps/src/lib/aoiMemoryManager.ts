...
export function extractHeuristicAoiMemoryCandidates(params: {
  ...
  const preferencePatterns = [
    ...
    /\b(?:i like|i really like|i love|i enjoy|i'?m a (?:huge |big )?fan of|i am a (?:huge |big )?fan of|i'?m obsessed with|i prefer|i dislike|i hate|i always prefer)\s+(.{2,120})/i,
  ];
