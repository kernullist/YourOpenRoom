const ko = {
  ...
  checkpoints: {
    ...
    restore: '복구',
    delete: '삭제',
    useActiveFile: '현재 파일 사용',
    empty: '아직 체크포인트가 없습니다.',
    loadedStatus: '{{count}}개 체크포인트를 불러왔습니다.',
    createdStatus: '{{name}} 생성됨, {{count}}개 파일.',
    restoredStatus: '{{name}} 복구됨, {{count}}개 파일.',
    deletedStatus: '{{name}} 삭제됨.',
    restoreConfirm: '"{{name}}" 체크포인트로 복구할까요? 해당 루트의 현재 파일이 덮어써집니다.',
    deleteConfirm: '"{{name}}" 체크포인트를 삭제할까요?',
    meta: '{{scope}} - {{count}}개 파일 - {{date}}',
    scopes: {
      ide: 'IDE',
      app_storage: '앱 저장소',
    },
